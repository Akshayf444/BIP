...
<!--                        <img u="image" src="Images/darkback.jpg" />-->
                        <div id="dv_top"  style="position: absolute;background-color: #7e9e49; top: 10px;width: 100%; height: 20px; font-size: 25px; font-weight:500; color: #fff; line-height: 30px;">Most No. Of BIP Device Check Camp</div>
                        <?php
                    ...
                    <div>
                        ...
                        ?>
<!--                        <img u="image" src="Images/darkback.jpg" />-->
                        <div id="Div1"  style="position: absolute; top: 10px;width: 100%;background-color: #7e9e49; height: 20px; font-size: 23px; color: #fff; line-height: 30px;">Most No. Of BIP Paramedic Meet</div>
                        ...
                        <br />
                        <div id="dv_tm2Rx"  u="caption" t="ZMF|10" style="position: absolute;left:0px; top: 170px; background-color: #7e9e49;width: 100%; height: 20px; font-size: 36px;font-weight:600;color:#fff;  line-height: 40px;"><?php echo isset($topper->Territory) ? $topper->Territory : 'NA'; ?></div>
                    </div>
                    <div>
                        <?php
