...
<div id="page-wrapper" style="background-image: url('images/screen2.jpg'); margin: 0px 0 0 0px; background-repeat:repeat-y; background-size:100%">
    ...
    <br />
    <?php
    $conditions = array('WHERE ba.BM_EMP_ID = ' . $BM_Emp_id);
...
<!--                        <img u="image" src="Images/darkback.jpg" />-->
                        <div id="dv_top"  style="position: absolute;background-color: #7e9e49;background-color: #7e9e49; top: 10px;width: 100%; height: 20px; font-size: 25px; font-weight:500; color: #fff; line-height: 30px;">Most No. Of BIP Device Check Camp</div>
                        <?php
                        $condition = array('GROUP BY ba.BM_Emp_Id ORDER BY device_check DESC LIMIT 1');
                    ...
                    <div>
                        <?php
                        $condition = array('GROUP BY ba.BM_Emp_Id ORDER BY paramedic DESC LIMIT 1');
                        $topper = Activity::BMActivity($condition);
                        if (!empty($topper)) {
                            $topper = array_shift($topper);
                        }
                        ?>
<!--                        <img u="image" src="Images/darkback.jpg" />-->
                        <div id="Div1"  style="position: absolute;background-color: #7e9e49; top: 10px;width: 100%; height: 20px; font-size: 23px; color: #fff; line-height: 30px;">Most No. Of BIP Paramedic Meet</div>
                    ...
                    <div>
                        <?php
                        $condition = array('GROUP BY ba.BM_Emp_Id ORDER BY chemist_meet DESC LIMIT 1');
                        $topper = Activity::BMActivity($condition);
                        if (!empty($topper)) {
                            $topper = array_shift($topper);
                        }
                        ?>
<!--                        <img u="image" src="Images/darkback.jpg" />-->
                        <div id="Div2"  style="position: absolute;background-color: #7e9e49;  top: 10px;width: 100%; height: 20px; font-size: 23px; color: #fff; line-height: 30px;">Most No. Of BIP Chemist Meet</div>
                    ...
                    <div>
                        <?php
                        $condition = array('GROUP BY ba.BM_Emp_Id ORDER BY visibility DESC LIMIT 1');
                        $topper = Activity::BMActivity($condition);
                        if (!empty($topper)) {
                            $topper = array_shift($topper);
                        }
                        ?>
<!--                        <img u="image" src="Images/darkback.jpg" />-->
                        <div id="Div2"  style="position: absolute;background-color: #7e9e49;  top: 10px;width: 100%; height: 20px; font-size: 23px; color: #fff; line-height: 30px;">Most No. Of Visibility At Clinics</div>
                        <div id="dv_tm3name"  u="caption" t="RTT|10" style="position: absolute;background-color: #7e9e49;left:0px;  top: 70px; width: 100%; height: 40px; font-size: 43px; color: #fff; line-height: 40px;"><?php echo isset($topper->BM_Name) ? $topper->BM_Name : 'NA'; ?></div>
                        <br />
